...
# data["F2xF23"] = data["F2"] * data["F23"]
# data["F3xF23"] = data["F3"] * data["F23"]
# data["F23xF25"] = data["F23"] * data["F25"]
...
rforest_grid = {
    "min_samples_leaf" : [88, 90, 92, 94, 96],
    "max_leaf_nodes" : [310, 325, 340],
}

# from sklearn.model_selection import GridSearchCV
# grid_search = GridSearchCV(rforest_clf, rforest_grid, cv=5, verbose=5000, scoring="roc_auc")
...
keras_clf = KerasClassifier(
    build_fn=create_nn, epochs=50, 
    batch_size=32, verbose=5)
